# -*- coding: utf-8 -*-
#
# Finite element course documentation build configuration file, created by
...
latex_documents = [
    (
        "index",
        "Finiteelementcourse.tex",
        u"Finite Elements: Analysis and Implementation",
        u"David A. Ham and Colin J. Cotter",
        "manual",
    ),
]
...
man_pages = [
    (
        "index",
        "finiteelementcourse",
        u"Finite element course Documentation",
        [u"David A. Ham and Colin J. Cotter"],
        1,
    )
]
...
texinfo_documents = [
    (
        ...
        u"David A. Ham and Colin J. Cotter",
        "Finiteelementcourse",
        "A masters level finite element course in the Department of Mathematics at Imperial College London",
        "Miscellaneous",
    ),
]
...
intersphinx_mapping = {
    ...
    "pop": ("https://object-oriented-python.github.io", None),
}
